...
const Features = () => {
  const features = [
    {
      title: "Үйлчилгээний чанарын баталгаа",
      description: "Тасралтгүй ажиллагаа",
      icon: (
    ...
    {
      title: "Мэргэшсэн инженерийн баг",
      description: "Олон жилийн туршлагатай мэргэжлийн баг хамт олон",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    ...
    },
    {
      ...
      description: "Мэдээллийн аюулгүй байдлын зөвлөгөө сургалт",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    ...
    {
      title: "Тохирсон шийдэл",
      description: "Байгууллагын онцлогт тохирсон шийдэл боловсруулах",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    ...
    {
      title: "Техникийн тусламж",
      description: "24/7 техникийн тусламж үйлчилгээ",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    ...
    {
      title: "Нууцлалын баталгаа",
      description: "Байгууллагын мэдээллийг хадгалах нууцын гэрээ",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    ...
    {
      title: "Уян хатан багц",
      description: "Албан байгууллагын хэрэгцээнд тохирсон багцын сонголт",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    ...
    },
    {
      ...
      description: "Шаардлагатай үед түргэн шуурхай хариу үйлчилгээ",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-24">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-16">
            <span className="text-neon-green">ЯГААД БИД</span> ГЭЖ ?
          </h2>
