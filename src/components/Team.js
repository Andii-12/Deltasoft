    ...
    <section className="py-12 bg-background relative">
      <div className="max-w-6xl mx-auto px-6">
        ...
        {loading ? (
          ...
          <div className="text-center text-text-light">Манай баг удахгүй нэмэгдэнэ...</div>
        ) : (
              ...
              >
                <div className="relative aspect-square overflow-hidden rounded mb-4">
                  {member.animeImage ? (
                    ...
                    <div className="w-full h-full bg-surface flex items-center justify-center text-text-light">No Image</div>
                  )}
                </div>
                <div>
