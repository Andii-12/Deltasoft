    ...
    <>
      ...
      <section className="min-h-screen bg-background text-text-primary py-12 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <h2 className="text-xl font-semibold text-primary mb-6 text-center">ДУУСГАССАН WEB АЖЛУУД</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
            {webProjects.map(project => <WebProjectCard key={project._id} project={project} />)}
          </div>

          <h2 className="text-xl font-semibold text-primary mb-6 text-center">ШИЙДСЭН СҮЛЖЭЭНИЙ АЖЛУУД</h2>
